...
class HomeRepository extends BaseRepository{
  ...
  Future<LoadingState<List<Vendor>?>> getVendors({int? stateId,bool? isNewVendors = false, List<int>? filterCategories}) async{
    var query = {
  ...
  Future<LoadingState<List<SliderData>?>> getSlider({String? type,int? categoryId}) async{
    return networkHandler.getRequest(
