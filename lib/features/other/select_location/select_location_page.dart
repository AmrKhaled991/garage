...
class _SelectLocationPageState extends State<SelectLocationPage> {
  ...
  @override
  void initState(){
    if(Get.arguments!=null && Get.arguments["lat"] != null && Get.arguments["lat"] != "0.0"&& Get.arguments["lat"] != "") {
        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Align(
                    alignment: Alignment.center,
                      child: Icon(Icons.add_location, size: 40, color: Theme.of(context).primaryColor,).marginOnly(bottom: 20)),
                  Positioned(
                    left: 8,
                      top: 8,
            ...
            MyButton(
              title: "confirm".tr,
              onClick: (){
                Get.back(result: MapEntry((_centerLocation?.latitude??0.0).toString(), (_centerLocation?.longitude??0.0).toString()));
              },
            ).marginAll(16)
          ],
        ),
