                ...
                Obx(
                  () => LoadingWidget(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount:
                          mainController.pages.value.data != null
                              ? mainController.pages.value.data?.length ?? 0
                              : 0,
                      itemBuilder: (context, index) {
                        var item = mainController.pages.value.data?.elementAt(
                          index,
                        );
                        return settingItem(
                          context,
                          item?.title ?? "",
                          icon:
                              item?.title?.toLowerCase().contains("terms") ==
                                      true
                                  ? "assets/images/ic_terms.svg"
                                  : "assets/images/ic_info.svg",
                          onClick: () {
                            Get.toNamed(
                              Routes.PAGE,
                              arguments: {
                                "page": mainController.pages.value.data!
                                    .elementAt(index),
                              },
                            );
                          },
  ...
  Widget settingItem(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            if (icon != null) MyImage(image: icon, width: 30, color: iconColor),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text("language".tr, style: MyTextStyle.myBlackSubTitle),
          ),
          Flex(
